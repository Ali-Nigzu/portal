...
const DEFAULT_DEMOGRAPHIC_TIME_WINDOW = resolveTimeWindow(
  null,
  undefined,
  new Date(),
);
const BASE_DEMOGRAPHIC_SPEC: Pick<
  ChartSpec,
  "dataset" | "chartType" | "timeWindow"
> = {
  dataset: "events",
  chartType: "categorical",
  timeWindow: DEFAULT_DEMOGRAPHIC_TIME_WINDOW,
};
const demographicDimension: Record<
  DemographicWidgetKind,
...
const mapSeries = (
  ...
  const aggregated = new Map<
    string,
    { count: number; code: string | number | null }
  >();
