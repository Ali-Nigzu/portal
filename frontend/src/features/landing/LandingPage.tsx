    ...
    <div className="landing-page">
      ...
      <section className="hero-section">
        <div className="hero-content">
          <h1 className="hero-title">
            {" "}
            Transform Your CCTV Footage
            <br /> Into{" "}
            <span className="highlight">Instant Business Insights</span>
          </h1>
          <p className="hero-subtitle">
            {" "}
            Your cameras capture everything. Now learn from it.
      ...
      <section className="problem-section">
        <div className="section-container">
          ...
          <p className="section-description">
            {" "}
            They're watching your customers, your staff, your space — every hour
            of every day.
            <br />
            But right now, they're only protecting you from risk.
            <br /> They're not helping you run your business better.
          </p>
          <p className="section-description" style={{ marginTop: "2rem" }}>
            camOS transforms your existing CCTV footage into real operational
            insight —<br />
          ...
          <div className="insights-list">
            <div className="insight-item">
              ...
              <span className="insight-text">
                When and where your business gets busiest
              </span>
            </div>
            <div className="insight-item">
              <span className="insight-bullet">•</span>
            ...
            <div className="insight-item">
              <span className="insight-bullet">•</span>
              <span className="insight-text">
                Which areas are underused or overstaffed
              </span>
            </div>
          </div>
          <p
          ...
          >
            No new hardware. No technical setup.
            <br />
      ...
      <section id="solution" className="solution-section">
        <div className="section-container">
          ...
          <p className="section-description">
            We transform raw CCTV footage into clear, actionable
            intelligence—without the hassle, technical complexity, or cost.
          </p>
          <div className="solution-cards">
            <div className="solution-card">
              ...
              <p>
                Real-time processing delivers insights immediately—no waiting,
                no complexity.
              </p>
            </div>
            <div className="solution-card">
              ...
              <p>
                Secure API connects to your existing CCTV system. Zero setup
                costs, zero disruption.
              </p>
            </div>
            <div className="solution-card">
              <div className="card-icon">[Icon]</div>
              ...
              <p>
                Intuitive interface tailored to your business needs—no technical
                expertise required.
              </p>
            </div>
          </div>
          ...
          <div className="features-grid">
            <div className="feature-item">
              ...
              <div className="feature-content">
                ...
                <p>
                  Designed for decision-makers who don't have time to waste
            ...
            <div className="feature-item">
              ...
              <div className="feature-content">
                ...
                <p>
                  Register your interest now for a limited time and get a full
                  year completely free. Zero hidden fees or subscription
                  traps—ever.
                </p>
              </div>
            </div>
            <div className="feature-item">
              ...
              <div className="feature-content">
                ...
                <p>
                  Turn routine footage into strategic insights that optimize
                  operations and improve forecasting.
                </p>
              </div>
            </div>
            <div className="feature-item">
              ...
              <div className="feature-content">
                ...
                <p>
                  Fits effortlessly into your existing workflows—start getting
                  value on day one.
                </p>
              </div>
            </div>
      ...
      <section id="register-form" className="form-section">
        <div className="form-container">
          ...
          <p className="form-subtitle">
            {" "}
            Join our waitlist and be among the first to experience frictionless
            visual intelligence.{" "}
          </p>{" "}
          {submitSuccess ? (
