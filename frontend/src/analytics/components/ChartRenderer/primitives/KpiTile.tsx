...
export const KpiTile = ({ series, height, className, result }: ChartPrimitiveProps) => {
  ...
  const hasVrmHover = Boolean(isVrm && vrmHover);
  const showVrmReferenceDot = Boolean(hasVrmHover && hoveredNumericValue !== null);
  const vrmHoverPoint = showVrmReferenceDot ? vrmHover : null;
            ...
            >
              <ResponsiveContainer width="100%" height={sparklineHeight}>
                ...
                >
                  ...
                  />
                  {showVrmReferenceDot && vrmHoverPoint && hoveredNumericValue !== null && (
                    <ReferenceDot
