...
describe('ChartRenderer high-level states', () => {
  ...
  it('routes empty VRM traffic data with chartStyle to the traffic empty view', () => {
    const trafficResult: ChartResult = {
      chartType: 'categorical',
      xDimension: { id: 'camera', type: 'category' },
      series: [
      ...
      meta: {
        timezone: 'UTC',
        summary: { presentation: 'vrm', chartSubType: 'traffic_distribution', chartStyle: 'traffic_distribution' } as any,
      },
    };
